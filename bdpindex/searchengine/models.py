...
from bdpindex.searchengine.errors import InvalidInputError
...
class UserProfileParameterSet(models.Model):
    """ Association of a user profile object with a specific schema.
        ...
        :attribute user_profile: the :class:`bdpindex.searchengine.models.MediaObject`
        :attribute schema:  the :class:`bdpindex.searchengine.models.Schema`
...
class UserProfileParameter(models.Model):
    """ The value for some metadata for a User Profile
        ...
        :parameter name: the associated  :class:`bdpindex.searchengine.models.ParameterName` that the value matches to
        :parameter paramset: associated  :class:`bdpindex.searchengine.models.UserProfile` and class:`bdpindex.searchengine.models.Schema` for this value
